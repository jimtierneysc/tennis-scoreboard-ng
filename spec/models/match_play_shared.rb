...
RSpec.shared_examples 'game not started' do
  it 'game started' do
    is_expected.not_to allow_win_game
  end
end

RSpec.shared_examples 'match not started' do
...
RSpec.shared_examples 'match just started' do
  it_behaves_like 'game not started'
  it_behaves_like 'match set in progress'
  it 'has no servers' do
    is_expected.to have_server_count(0)
  end
end

RSpec.shared_examples 'match set in progress' do
...
RSpec.shared_examples 'match with game' do
  it 'has last game' do
    is_expected.to have_last_game
  end
end

RSpec.shared_examples 'match with game in progress' do
  it 'have game in progress' do
    is_expected.to have_game_in_progress
  end
end

RSpec.shared_examples 'match with one game' do
  it 'has one game' do
    is_expected.to have_game_count(1)
  end
end

RSpec.shared_examples 'match with two games' do
  it 'has two games' do
    is_expected.to have_game_count(2)
  end
end

RSpec.shared_examples 'match with game won' do
  it 'does have winner' do
    is_expected.to have_game_with_winner
  end
end

RSpec.shared_examples 'match can start set tiebreaker' do
  it 'can start set tiebreaker' do
    is_expected.to allow_action :start_tiebreaker
  end
end

RSpec.shared_examples 'match in set tiebreaker' do
  it 'can win set tiebreaker' do
    is_expected.to allow_action :win_tiebreaker
  end
end

RSpec.shared_examples 'match with finished set' do
  it 'has finished set' do
    is_expected.to have_finished_set
  end
end

RSpec.shared_examples 'match can start match tiebreaker' do
  it 'can start set tiebreaker' do
    is_expected.to allow_action :start_match_tiebreaker
  end
end

RSpec.shared_examples 'match in match tiebreaker' do
  it 'can win set tiebreaker' do
    is_expected.to allow_action :win_match_tiebreaker
  end
end

RSpec.shared_examples 'match finished' do
  it 'is finished' do
    is_expected.to be_finished
  end
end

RSpec.shared_examples 'match set can be completed' do
  it 'can complete set' do
    is_expected.to allow_action :complete_set_play
  end
end

RSpec.shared_examples 'match with complete set' do
  it 'has completed set' do
    is_expected.to have_complete_set
  end
end

RSpec.shared_examples 'match can be completed' do
  it 'can be completed' do
    is_expected.to allow_action :complete_play
  end
end

RSpec.shared_examples 'match complete' do
  it 'is completed' do
    is_expected.to be_complete
  end
end

RSpec.shared_examples 'match with first game started' do
  it_behaves_like 'match with game in progress'
  it_behaves_like 'match with one game'
  it 'has server' do
    is_expected.to have_server_count(1)
  end
end

RSpec.shared_examples 'match with second game started' do
  it_behaves_like 'match with game in progress'
  it_behaves_like 'match with two games'
  it 'has servers' do
    if subject.doubles
      is_expected.to have_server_count(2)
    else
      is_expected.to have_server_count(1)
    end
  end
