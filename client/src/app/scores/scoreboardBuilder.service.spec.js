(function () {
  ...
  describe('service scoreBuilder', function () {
    ...
    describe('service', function () {
      ...
      describe('#server', function () {
        ...
        describe('match in-progress', function () {
          var scores;
          beforeEach(function () {
            scores = makeScores(inProgress);
          });

          it('should have serving when in_progress', function () {
            expect(service.server(scores)).toEqual(server);
          });

          it('should not have serving when winner', function () {
            scores.sets[0].games[1].winner = server;
            expect(service.server(scores)).toEqual(null);
          });

          it('should not have serving when no games', function () {
            scores.sets[0].games = [];
            expect(service.server(scores)).toEqual(null);
          });

          it('should not have serving when no sets', function () {
            scores.sets = [];
            expect(service.server(scores)).toEqual(null);
          });
        });

        describe('match not in progress', function () {
          it('should not have serving ', function () {
      ...
      describe('#newGame', function () {
        ...
        describe('for different actions', function () {
          var sampleScores = {
            doubles: false,
            actions: actions,
            servers: [1],
          ...
          angular.forEach(actions, function (value, key) {
            describe(key, function () {
              ...
              if (value) {
                ...
                it('does not creates new game', function () {
      ...
      describe('#firstServers', function () {
        ...
        describe('doubles match', function () {
          ...
          it('should not list when two server', function () {
            scores.servers = [1, 3];
            var firstServers = service.firstServers(scores);
            expect(firstServers).toBe(null);
          });
          ...
          angular.forEach(actions, function (value, key) {
            describe(key, function () {
              ...
              if (value) {
                ...
                it('does not creates new set', function () {
